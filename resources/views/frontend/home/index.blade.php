                        ...
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="{{ route('post.details', $post->id) }}">
                                    <img class="card-img-bottom d-block radius-image" src="{{ asset('/post/'.$post->image) }}"  alt="Card image cap" style="width: full; height:200px;" >
                                </a>
                                <div class="post-pos">
                            ...
                            <div class="card-body p-0 blog-details">
                                <a href="{{ route('post.details', $post->id) }}" class="blog-desc">{{  Str::substr($post->title, 0, 25) }}
                                </a>
                                <p>{{ Str::substr($post->short_description, 0, 55) }}</p>
                                <div class="p-footer mt-3">
                                    <div class="p-meta-info">
                                        <a href="{{ route('post.details', $post->id) }}" class="post-img-anchor">
                                            <img src="{{ asset('/frontend/') }}/assets/images/a1.jpg" alt=""
                                                class="post-img radius-img img-fluid" />
                                        </a>
                                        <a href="#url">Elizabeth</a>
                                    </div>
                                    <a href="{{ route('post.details', $post->id) }}" class="read">Read more <span class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pos-sticky">
                    ...
                    <div class="tweets mt-5">
                        ...
                        <ul class="blog-cat twitter-feed">
                            <li>
                                <a href="#url">  help Developers, Designers, Website owners create
                                    Stunning Websites #design…
                                    <br><em class="twitter-date">Oct 4, 2020</em></a>
                            </li>
                            <li>
                                <a href="#url"> Delog starter just evolved. has acquired the
